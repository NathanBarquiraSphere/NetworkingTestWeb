...
export class PingServerUnreliableResponse {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):PingServerUnreliableResponse {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsPingServerUnreliableResponse(bb:flatbuffers.ByteBuffer, obj?:PingServerUnreliableResponse):PingServerUnreliableResponse {
  return (obj || new PingServerUnreliableResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsPingServerUnreliableResponse(bb:flatbuffers.ByteBuffer, obj?:PingServerUnreliableResponse):PingServerUnreliableResponse {
...
static startPingServerUnreliableResponse(builder:flatbuffers.Builder) {
...
static endPingServerUnreliableResponse(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static createPingServerUnreliableResponse(builder:flatbuffers.Builder, sessionId:number, sentOffset:flatbuffers.Offset):flatbuffers.Offset {
