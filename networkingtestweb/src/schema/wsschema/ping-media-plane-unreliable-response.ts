...
export class PingMediaPlaneUnreliableResponse {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):PingMediaPlaneUnreliableResponse {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsPingMediaPlaneUnreliableResponse(bb:flatbuffers.ByteBuffer, obj?:PingMediaPlaneUnreliableResponse):PingMediaPlaneUnreliableResponse {
  return (obj || new PingMediaPlaneUnreliableResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsPingMediaPlaneUnreliableResponse(bb:flatbuffers.ByteBuffer, obj?:PingMediaPlaneUnreliableResponse):PingMediaPlaneUnreliableResponse {
...
static startPingMediaPlaneUnreliableResponse(builder:flatbuffers.Builder) {
...
static endPingMediaPlaneUnreliableResponse(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static createPingMediaPlaneUnreliableResponse(builder:flatbuffers.Builder, sessionId:number, sentOffset:flatbuffers.Offset):flatbuffers.Offset {
